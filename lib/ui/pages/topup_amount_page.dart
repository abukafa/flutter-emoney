...
import 'package:flutter_emoney/blocs/topup/topup_bloc.dart';
...
class TopupAmountPage extends StatefulWidget {
  ...
  const TopupAmountPage({super.key, this.data});
  ...
  void initState() {
    ...
    amountController.addListener(() {
      ...
      amountController.value = amountController.value.copyWith(
        text: NumberFormat.decimalPattern('id').format(number),
        selection: TextSelection.collapsed(
          offset: NumberFormat.decimalPattern('id').format(number).length,
        ),
      );
    });
  }
          ...
          builder: (context, state) {
            ...
            return ListView(
              ...
              children: [
                ...
                SizedBox(height: 25),
                CustomTextButton(title: 'Term & Conditions', onPressed: () {}),
                SizedBox(height: 40),
              ],
            );
          },
